 ...
 * under the License.
 */
import { SupersetPluginChartBigNumberModified } from '../src';
 ...
 */
describe('superset-plugin-chart-big-number-modified', () => {
  it('exists', () => {
    expect(SupersetPluginChartBigNumberModified).toBeDefined();
  });
});
